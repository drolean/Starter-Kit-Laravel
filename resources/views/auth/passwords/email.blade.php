        ...
        <div class="session">
            <div class="session-content">
                <div class="card card-body form-layout">
                    <form role="form" method="POST" action="{{ url('/password/email') }}" id="validate">
                        {{ csrf_field() }}
                        <div class="text-center mb-3">
                            <h3 class="box-title">Recuperar sua Senha?</h3>
                            <p>Digite seu email abaixo e nós lhe enviaremos<br> instruções sobre como alterar sua senha.</p>
                        </div>
                        ...
                        <button class="btn btn-info btn-block btn-custom" type="submit"> ENVIAR </button>
                    </form>
                </div>
            </div>
